...
app.layout = html.Div([
    ...
    html.Div(dcc.Dropdown(
        ...
        placeholder='Select a year to show Year\'s report',
        style={'width':'80%','padding':'3px', 'font-size':'20px','textAlign': 'center'},
    )),
...
def update_output_container(year, statistics):
    if statistics == 'Recession Period Statistics':
        ...
        R_chart2 = dcc.Graph(figure=px.line(average_sales,
                                            x='Vehicle_Type',
                                            y='Automobile_Sales',
                                            title='Average Automobile Sales sold by Vehicle Types'))
        ...
        R_chart4 = dcc.Graph(figure= px.histogram(data,
                                                  color='Vehicle_Type',
                                                  x='unemployment_rate',
                                                  barmode='group',
                                                  title='Bar chart for the effect fo unemployment rate on vehicle type and sales'))
    ...
    # Yearly Statistic Report Plots
    elif (statistics == 'Yearly Statistics'):
        ...
        Y_chart2 = dcc.Graph(figure=px.line(monthly_data,x='Month',y='Automobile_Sales',
        ...
        Y_chart4 = dcc.Graph(figure=px.bar(exp_data,
                                           ...
                                           color='Vehicle_Type',
                                           title= 'Total Advertisement Expenditure in the year {}'.format(year)))
